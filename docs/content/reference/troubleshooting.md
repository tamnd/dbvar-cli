...
Most of these come down to network reality or how dbvar serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dbvar rate-limits like any public site. dbvar already paces
...
Where a surface is gated, dbvar reads a cookie or token you supply
...
`dbvar`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dbvar actually did
