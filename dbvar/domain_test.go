...
// HTTP behaviour is covered in dbvar_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "dbvar://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("dbvar", "about")
	if err != nil || got.String() != "dbvar://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want dbvar://page/about", got.String(), err)
	}
}
